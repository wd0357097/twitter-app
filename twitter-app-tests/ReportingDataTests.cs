...
namespace twitter_app_tests
{
    ...
    public class ReportingDataTests
    {
        ...
        {
            _data.TotalNumberOfTweets.ShouldBe(489);
        }
        ...
        public void average_number_of_tweets_by_time_test()
        {
            ...
            _data.AverageNumberOfTweets(time.TimeOfDay.TotalHours).ShouldBe(322.36d);
            _data.AverageNumberOfTweets(time.TimeOfDay.TotalMinutes).ShouldBe(5.37d);
            _data.AverageNumberOfTweets(time.TimeOfDay.TotalSeconds).ShouldBe(0.09d);
        }
        ...
        {
            _data.PercentOfTweetsThatContainsEmojis.ShouldBe(25.56d);
        }
        ...
        {
            _data.PercentOfTweetsThatContainUrl.ShouldBe(34.97d);
        }

        [TestMethod]
        public void percent_of_tweets_that_contain_photo_urls_test()
        {
            _data.PercentOfTweetsThatContainPhotoUrl.ShouldBe(18.2d);
        }
