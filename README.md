...
1. twitter-app-console
   ...
   - Twitter API Token is located in the app.config file, this can be replaced with your own token
2. twitter-app.tests
...
3. twitter-app.ui
   ...
   -  Uses DI, (Singleton intance) setup to inject an instance of reporting data 
   -  Twitter API Token is located in the appsettings.json file, this can be replaced with your own token
4. twitter-data
